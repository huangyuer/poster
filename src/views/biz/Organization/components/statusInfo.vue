...
<div>
    ...
    <ep-model title="组织操作记录" v-model="modelFlag" width="1350px" :wrap-close="false">
        <div class="search-table">
                <div class="ep-card card-margin relative" style="top:10px;">
                    <div class="card-body">
                        ...
                        <div class="block">
                        <ep-table border ref="table" :height="400" :data="ep_data" :head-color="true"  :loading="loading">
...
export default {
    ...
    methods:{
        refresh(){
            this.$post("orgGetOrgStatus",this.searchForm).then(res=>{

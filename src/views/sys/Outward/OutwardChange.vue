      ...
      <div class="panel panel-default">
        ...
        <ep-tabs active="耗料清单表头">
          ...
          <ep-tab-item name="耗料清单耗用表体">
            <formBodyOut ref="formBody" :listData="tableDataCopy" :headerForm="headerForm" :changeType="true"></formBodyOut>
          </ep-tab-item>
          <ep-tab-item name="耗料清单产出表体">
            <formBodyIn ref="formBody1" :listData="tableDataCopy1" :headerForm="headerForm" :changeType="true"></formBodyIn>
          </ep-tab-item>
        </ep-tabs>
      </div>
    </div>

  ...
  <div>
        ...
        <ep-row :gutter="7">
          <ep-form-item label="ERP/WMS出入库编号" attr="inExpWhNo">
            <ep-input
              ...
              name="inExpWhNo"
              :maxlength="64"
              :disabled="isDtInExp&&headerForm.optStatus!='5'||dragEdit"
            ></ep-input>
          </ep-form-item>
        </ep-row>
        <ep-row :gutter="7">
    ...
    <div class="ep-card card-margin relative">
      <div class="card-body">
        ...
        <div class="block" v-if="isDtInExp&&headerForm.optStatus=='5'&&!dragEdit">
          <!-- <ep-button type="primary" size="small" @click="doBodyAdd" icon="plus-round">添加</ep-button> -->
        ...
        <div class="block">
          ...
          >
            ...
            <ep-table-item column="opt" title="操作" width="200" v-if="!isDtInExp&&!dragEdit && showInexp && inexpRlt">
              <template slot-scope="props">
                <wms-icon type="cancel" @click="doBodyDelete(props.row,props.row.id)" v-if="showInexp && inexpRlt"></wms-icon>
              </template>
            </ep-table-item>
            <ep-table-item
              column="opt"
              title="操作"
              width="200"
              v-if="isDtInExp&&headerForm.optStatus=='5'&&!dragEdit  && showInexp && inexpRlt"
            >
              <template slot-scope="props">

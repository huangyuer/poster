    ...
    <div>
      ...
      <div class="ep-card card-margin relative">
        <div class="card-body">
          <div class="block"></div>
          <div class="block">
            <ep-table ref="table" :height="400" :data="tableData" :head-color="true" @row-dblclick="queryOperStatus">
              <!-- <ep-table-item column="createTime" width="200" title="创建时间"></ep-table-item> -->
              <ep-table-item column="optStatus" width="300" title="操作状态" :formatter="statusFormatter"></ep-table-item>
              <ep-table-item column="optUserName" width="300" title="操作人"></ep-table-item>
              <ep-table-item column="optTime" width="300" title="操作时间"></ep-table-item>

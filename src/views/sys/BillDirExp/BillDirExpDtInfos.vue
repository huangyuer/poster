      ...
      <div class="panel panel-default">
        <ep-tabs active="径予放行货物自主声明表头">
              ...
              <ep-row :gutter="10">
                ...
                <ep-col :col="8">
                  <ep-form-item label="径予放行自主声明编号" attr="billExpNo">
                    <ep-input v-model="bodyForm.billExpNo" name="billExpNo" :disabled="true"></ep-input>
                  </ep-form-item>
                </ep-col>
                <ep-col :col="8">
                ...
                <ep-col :col="8">
                  <ep-form-item label="经营单位名称" attr="bizopEtpsNm">
                    <ep-input v-model="bodyForm.bizopEtpsNm" name="grossWt" :maxlength="20" :disabled="true"></ep-input>
                  </ep-form-item>
                </ep-col>
                <ep-col :col="8">
                  <ep-form-item label="经营企业编号" attr="bizopEtpsNo">
                    <ep-input v-model="bodyForm.bizopEtpsNo" name="grossWt" :maxlength="20" :disabled="true"></ep-input>
                  </ep-form-item>
                </ep-col>

                <ep-col :col="8">
                  <ep-form-item label="经营单位社会信用代码" attr="bizopEtpsSccd">
                    <ep-input v-model="bodyForm.bizopEtpsSccd" name="grossWt" :maxlength="20" :disabled="true"></ep-input>
                  </ep-form-item>
                </ep-col>
                <!--新增的备用行-->
                ...
                <ep-col :col="8">
                  <ep-form-item label="申报单位名称" attr="bizopEtpsNmAttr">
                    <ep-input v-model="bodyForm.bizopEtpsNmAttr" name="grossWt" :maxlength="20" :disabled="true"></ep-input>
                  </ep-form-item>
                </ep-col>
                <ep-col :col="8">
                  <ep-form-item label="申报企业编号" attr="bizopEtpsNoAttr">
                    <ep-input v-model="bodyForm.bizopEtpsNoAttr" name="grossWt" :maxlength="20" :disabled="true"></ep-input>
                  </ep-form-item>
                </ep-col>

                <ep-col :col="8">
                  <ep-form-item label="申报单位社会信用代码" attr="bizopEtpsSccdAttr">
                    <ep-input v-model="bodyForm.bizopEtpsSccdAttr" name="grossWt" :maxlength="20" :disabled="true"></ep-input>
                  </ep-form-item>
                </ep-col>
                <!--新增数据完结-->
                <ep-col :col="8">
                ...
                <ep-col :col="8">
                  <ep-form-item label="状态" attr="optStatus">
                    <ep-select v-model="bodyForm.optStatus" name="optStatus" :disabled="true">
                      ...
                      <ep-select-item index="22" label="已出运"></ep-select-item>
                      <ep-select-item index="20" label="待出运"></ep-select-item>
                    </ep-select>
                  </ep-form-item>
                </ep-col>
                <ep-col :col="8">
                ...
                <ep-col :col="8">
                  <ep-form-item label="已出运状态" attr="col1">
                    <ep-select v-model="bodyForm.col1" name="col1" :disabled="true">
                      <ep-select-item index="20" label="待出运"></ep-select-item>
                      <ep-select-item index="22" label="已出运"></ep-select-item>
                    </ep-select>
                  </ep-form-item>
                ...
                <!-- <ep-col :col="8">
                  <ep-form-item label="危禁品确认标志" attr="hazardousConfirm">
                    <ep-select v-model="bodyForm.hazardousConfirm" name="hazardousConfirm" :disabled="true">
                ...
                <!-- <ep-col :col="8">
                  <ep-form-item label="危禁品" attr="hazardous">
                    <ep-input v-model="bodyForm.hazardous" name="hazardous" :disabled="true"></ep-input>
                  </ep-form-item>
                </ep-col>-->
                <!-- <ep-col :col="8">
                ...
                <ep-col :col="16">
                  <ep-form-item label="备注" attr="rmk">
                    <ep-input v-model="bodyForm.rmk" name="rmk" :disabled="true"></ep-input>
                  </ep-form-item>
                </ep-col>
                <ep-col :col="24">
          ...
          <ep-tab-item name="径予放行货物自主声明明细">
            <ep-model title="出境径予放行货物自主声明明细" v-model="bodyDtModel" width="1250px" :wrap-close="false">
                ...
                <ep-row :gutter="7">
                  ...
                  <ep-col :col="8">
                    <ep-form-item attr="gdsSeqno" label="明细序号">
                      <ep-input v-model.trim="bodyDtForm.gdsSeqno" name="gdsSeqno" disabled></ep-input>
                    </ep-form-item>
                  </ep-col>
                  <ep-col :col="8">
                    <ep-form-item attr="gdsMtno" label="商品料号">
                      <ep-input v-model="bodyDtForm.gdsMtno" name="gdsMtno" :maxlength="32" :disabled="true"></ep-input>
                    </ep-form-item>
                  </ep-col>
                  <ep-col :col="8">
                  ...
                  <ep-col :col="8">
                    <ep-form-item attr="dclQty" label="申报数量">
                      <ep-input v-model="bodyDtForm.dclQty" name="dclQty" :maxlength="20" :disabled="true"></ep-input>
                    </ep-form-item>
                  </ep-col>
                  <ep-col :col="8">
                    <ep-form-item attr="dclUnitcd" label="申报计量单位">
                      <ep-select v-model="bodyDtForm.dclUnitcd" name="dclUnitcd" filterable :disabled="true">
            ...
            <div class="ep-card card-margin relative">
              <div class="card-body">
                <div class="block">
                  <ep-table border ref="table" :height="400" :data="tableData" :head-color="headColor" @row-dblclick="handleDetailClick">
                    <ep-table-item column="billNo" width="200" title="径予放行自主声明编号"></ep-table-item>
                    <ep-table-item column="gdsSeqno" width="200" title="明细序号"></ep-table-item>
          ...
          <ep-tab-item name="集装箱">
            <ep-model title="集装箱" v-model="containerModel" width="1250px" :wrap-close="false">
              <ep-form ref="containerForm" :form="containerForm" name-width="168px">
                <ep-row :gutter="7">
                  <ep-col :col="8">
                    <ep-form-item attr="billNo" label="径予放行自主声明编号">
                      <ep-input v-model="containerForm.billNo" name="billNo" :disabled="true"></ep-input>
                    </ep-form-item>
                  </ep-col>
                  <ep-col :col="8">
                    <ep-form-item attr="container" label="集装箱号">
                      <ep-input v-model="containerForm.container" name="container" :disabled="true"></ep-input>
                    </ep-form-item>
                  </ep-col>
                </ep-row>
              </ep-form>
            ...
            <div class="ep-card card-margin relative">
              <div class="card-body">
                <div class="block">
                  <ep-table border ref="containerTable" :height="400" :data="containerTableData" :head-color="headColor" @row-dblclick="handleContainerClick">
                ...
                <div class="block">
                  <ep-pager right @size-change="handleSizeChange1" @change="handleCurrentChange1" :now-page="ep_page1.page1" :page-size="ep_page1.size1" :total-num="totalcount1"></ep-pager>
                </div>
              </div>
            </div>
          </ep-tab-item>
            ...
            <ep-model title="关联出入库单证" v-model="inAndOutModel" width="1400px" :wrap-close="false">
              <ep-form ref="inAndOutForm" :form="inAndOutForm" :rules="InExp_rules" name-width="168px">
                <ep-row :gutter="20">
                  <ep-col :col="10">
                    <ep-form-item attr="billNo" label="径予放行自主声明编号">
                      <ep-input v-model="bodyForm.billExpNo" name="billNo" :maxlength="20" :disabled="true"></ep-input>
                    </ep-form-item>
                  </ep-col>
                  ...
                  <ep-col :col="10">
                    <ep-form-item attr="rmk" label="备注">
                      <ep-input v-model.trim="inAndOutForm.rmk" autosize name="rmk" type="textarea" :maxlength="1000"></ep-input>
                    </ep-form-item>
                  </ep-col>
                </ep-row>
                <ep-row>
            ...
            <div>
              ...
              <div class="ep-card card-margin relative">
                <div class="card-body">
                  ...
                  <div class="block">
                    <ep-table border ref="table" :height="400" :data="tableInExpData" :loading="loading" @row-dblclick="select1Info" head-color @selection-change="handleSelectionChange">
            ...
            <div>
              ...
              <div class="ep-card card-margin relative">
                <div class="card-body">
                  <div class="block"></div>
                  <div class="block">
                    <ep-table border ref="table" :height="400" :data="table2Data" :loading="loading" head-color @row-dblclick="select2Info">
  ...
  data() {
    return {
      ...
      bodyForm: {
        ...
        tradeId: "",
        masterCuscd: "",
        billExpNo: "", //径予放行自主声明编号	BILL_EXP_NO
      ...
      tableDataCopy: [],
      table2Data: [], // 操作记录表格数据
      containerTableData: [], // 集装箱号表格数据
      containerTableDataCopy: [],
  ...
  methods: {
    ...
    makeSure(value) {
      ...
      this.$refs["inAndOutForm"].validate((valid) => {
        if (valid) {
          if (value == "添加") {
            this.inAndOutForm.billNo = this.bodyForm.billExpNo;
            ...
            this.$post("billDirWhSaveExp", inAndOutFormCopy)
              .then((res1) => {
          ...
          if (value == "修改") {
            let inAndOutForm = this.inAndOutForm;
            let inAndOutFormCopy = cloneObj(this.inAndOutForm);
            this.$post("billDirWhSaveExp", inAndOutFormCopy)
              .then((res1) => {
                this.saveLoading = false;
                this.isDeclare = true;
                this.inAndOutForm.id = String(res1.map.id);
              })
              .catch(() => {
                this.saveLoading = false;
              });
    ...
    confirmInAndOut() {
      ...
      this.$post("confirmInAndOutExp", data)
        .then((responseData) => {
          this.$pop({
            type: "success",
            message: "确认成功",
      ...
      this.$confirm({
        ...
        callback: (errorInfo) => {
          if (errorInfo) {
            ...
            let data = {};
            data["ids"] = bscIds;
            this.$post("deleteInAndOutExp", data)
              .then((responseData) => {
                selectData.forEach((c) => {
    ...
    againDate(id) {
      this.$post("billDirExpDetail", { id: id }).then((res) => {
        ...
        this.containerTableDataCopy = res.map.data.billDirExpCon;
        // -------
        let tableDataCopy = cloneObj(this.tableDataCopy);
        let containerTableDataCopy = cloneObj(this.containerTableDataCopy);
        tableDataCopy.forEach((e, i) => {
          e.leadId = i;
        });
        containerTableDataCopy.forEach((e, i) => {
          e.leadId = i;
        });
        this.tableDataCopy = tableDataCopy;
        this.containerTableDataCopy = containerTableDataCopy;
        this.ep_page.size = 10;
        this.ep_page.page = 1;
        this.makePaging(this.ep_page.size, this.ep_page.page, tableDataCopy);
        this.containerMakePaging(
          this.ep_page.size,
          this.ep_page.page,
          containerTableDataCopy
        );
        this.table2Data = res.map.data.billDirExpStatus;
        this.tableInExpData = res.map.data.billDirExpWh;
    ...
    containerMakePaging(size, page, data) {
      let begin = (page - 1) * size;
      let end = begin + size;
      let newData = data.slice(begin, end);
      this.totalcount1 = data.length;
      this.containerTableData = newData;
    },
    ...
    handleCurrentChange1(val) {
      this.ep_page1.page1 = val;
      this.containerMakePaging(
        this.ep_page1.size1,
        this.ep_page1.page1,
        this.filterData({}, this.containerTableDataCopy)
      );
    },

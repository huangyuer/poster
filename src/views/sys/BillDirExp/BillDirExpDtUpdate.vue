      ...
      <div class="panel panel-default">
        ...
        <ep-tabs active="径予放行货物自主声明表头">
              ...
              <ep-row :gutter="10">
                ...
                <!-- <ep-col :col="8">
                  <ep-form-item label="径予放行自主声明编号" attr="billExpNo">
                    <ep-input v-model="bodyForm.billExpNo" name="billExpNo" :maxlength="18" :disabled="true"></ep-input>
                  </ep-form-item>
                </ep-col>-->
                ...
                <!-- <ep-col :col="8">
                  <ep-form-item label="件数" attr="dclQty">
                    <ep-input v-model="bodyForm.dclQty" name="dclQty" :maxlength="20"></ep-input>
                  </ep-form-item>
                </ep-col>-->
                <ep-col :col="8">
                ...
                <ep-col :col="8">
                  <ep-form-item attr="mtpckEndprdTypecd" label="料件 /成品标志">
                    <ep-select v-model="bodyForm.mtpckEndprdTypecd"  name="mtpckEndprdTypecd">
          ...
          <ep-tab-item name="径予放行货物自主声明明细">
            <ep-model title="径予放行货物自主声明明细" v-model="model" width="1250px" :wrap-close="false">
              <ep-form ref="bodyDtForm" :form="bodyDtForm" :rules="page_rules1" name-width="168px">
                <ep-row :gutter="7">
                  <ep-col :col="8">
                    <ep-form-item attr="billExpNo" label="径予放行自主声明编号">
                      <ep-input v-model="bodyDtForm.billExpNo" name="billExpNo" :maxlength="20" :disabled="true"></ep-input>
                    </ep-form-item>
                  </ep-col>
                  <!--<ep-col :col="8">
              ...
              <div class="card-body">
                ...
                <div class="block">
                  <ep-table border ref="table" :height="400" :data="tableData" :head-color="headColor">
                    ...
                    <ep-table-item column="billExpNo" width="200" title="径予放行自主声明编号"></ep-table-item>
          ...
          <ep-tab-item name="集装箱">
            <billDirExpDtContainerList ref="billDirExpDtContainerList" :containers="containers"></billDirExpDtContainerList>
          </ep-tab-item>
        </ep-tabs>
      </div>
    </div>
  ...
  methods: {
    ...
    doSave() {
      this.$refs["bodyForm"].validate((valid) => {
        if (valid) {
          //在1,4,6 暂存、海关入库失败、审核失败【拒绝
          //状态下可以暂存
          if (
            this.bodyForm.optStatus != "1" &&
            this.bodyForm.optStatus != "4" &&
            this.bodyForm.optStatus != "6" &&
            this.bodyForm.optStatus != "501" &&
            this.bodyForm.optStatus != "601" &&
            this.bodyForm.optStatus != "504" &&
            this.bodyForm.optStatus != "604" &&
            this.bodyForm.optStatus != "506" &&
            this.bodyForm.optStatus != "606" &&
          ...
          bodyFormCopy["billDirExpCon"] = this.$refs.billDirExpDtContainerList
            ? this.$refs.billDirExpDtContainerList.tableDataCopy
            : this.containers;
    ...
    declare() {
      this.$refs["bodyForm"].validate((valid) => {
        if (!valid) {
          ...
          console.log("------111", this.bodyForm.hazardousConfirm);
            ...
            async callback(info) {
              if (info) {
                try {
                  ...
                  let result = await vm.$post("billDirExpDtUpdate", data);

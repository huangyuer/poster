              ...
              <ep-row :gutter="10">
                ...
                <!-- <ep-col :col="8">
                  <ep-form-item label="径予放行自主声明编号" attr="billNo">
                    <ep-input v-model="bodyForm.billNo" name="billNo" :maxlength="18"></ep-input>
                  </ep-form-item>
                </ep-col>-->
                <!-- <ep-col :col="8">
                  <ep-form-item label="自主声明预录入编号" attr="orderNo">
                    <ep-input v-model="bodyForm.orderNo" name="orderNo" :maxlength="20"></ep-input>
                  </ep-form-item>
                </ep-col>-->
                <!-- <ep-col :col="8">
                   <ep-form-item label="">
              ...
              <div class="card-body">
                ...
                <div class="block">
                  <ep-table border ref="table" :height="400" :data="tableData" :head-color="headColor">
                    ...
                    <ep-table-item column="gdsMtno" width="150" title="商品料号"></ep-table-item>

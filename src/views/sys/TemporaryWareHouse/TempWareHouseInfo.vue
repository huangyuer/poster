        ...
        <div class="block">
          ...
          >
            ...
            <ep-table-item
              ...
              title="进出标志"
              width="100"
              :formatter="ioTypecdFormatter"
            ></ep-table-item>
            <ep-table-item
              column="invtIochkptStucd"
              title="进出卡口状态"
              width="150"
              :formatter="invtIFormatter"
            ></ep-table-item>
            <ep-table-item column="vrfdedMarkcd" title="核扣标记" width="100" :formatter="vrfFormatter"></ep-table-item>
            <ep-table-item
              column="passportUsedTypecd"
              title="绑定状态"
              width="150"
              :formatter="passportUsedTypecd"
            ></ep-table-item>
            <ep-table-item
              column="mtpckEndprdTypecd"
              title="料件/成品标志"
              width="150"
              :formatter="mtpckEndprdTypecdFormatter"
            ></ep-table-item>
            <ep-table-item
              column="supvModecd"
              title="监管方式"
              width="150"
              :formatter="supvModecdFormatter"
            ></ep-table-item>
            <ep-table-item
              column="trspModecd"
              title="运输方式"
              width="100"
              :formatter="trspModecdFormatter"
            ></ep-table-item>
            <ep-table-item
              column="impexpPortcd"
              title="进出境关别"
              width="120"
              :formatter="impexpPortcdFormatter"
            ></ep-table-item>
            ...
            <ep-table-item
              ...
              title="报关类型"
              width="150"
              :formatter="dclcusTypecdFormatter"
            ></ep-table-item>
            <ep-table-item
              column="dclcusFlag"
              title="是否报关"
              width="100"
              :formatter="dclcusFlagFormatter"
            ></ep-table-item>
            <ep-table-item
              column="relDclcusFlag"
              title="报关标志"
              width="150"
              :formatter="dclcusFormatter"
            ></ep-table-item>
            <ep-table-item
              column="destinationNatcd"
              title="最终目的国(地区)"
              width="150"
            ...
            <ep-table-item
              ...
              title="启运国/运抵国(地区)"
              width="200"
              :formatter="tradeCountryTranslate"
            ></ep-table-item>
            <ep-table-item
              column="tradingRegion"
              title="贸易国(地区)"
              width="150"
              :formatter="regionTranslate"
            ></ep-table-item>
            <ep-table-item
              :formatter="districtCodeFormatter"
              column="districtCode"
              title="境内目的地/货源地"
              width="200"
            ></ep-table-item>

  ...
  <div>
        ...
        <ep-row :gutter="7">
          <ep-col :col="8">
            <ep-form-item label="凭证编号" attr="portNo" disabled>
              <ep-input disabled v-model="portReleaseDt.whRecPreentNo" :maxlength="30"></ep-input>
            </ep-form-item>
          </ep-col>
          <ep-col :col="8">
          ...
          <ep-col :col="8">
            <ep-form-item attr="dclUprcAmt" label="单价">
              <ep-input disabled v-model="portReleaseDt.dclUprcAmt" name="dclUprcAmt" :maxlength="26"></ep-input>
            </ep-form-item>
          </ep-col>
          <ep-col :col="8">
    ...
    <div class="block">
      <ep-table ref="table" border :height="400" :data="tableData" @selection-change="handleSelect" @row-dblclick="select1Info" :head-color="headColor">
        ...
        <ep-table-item column="whRecPreentNo" title="凭证编号" width="210"></ep-table-item>

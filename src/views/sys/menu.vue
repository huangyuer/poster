  ...
  <div class="panel-main-content">
    ...
    <div class="ep-card card-margin relative">
      ...
      <div class="card-body">
        ...
        <div class="block">
          <ep-table ref="table" :data="ep_data" :height="700" @selection-change="handleSelectionChange" can-edit :loading="loading">
            ...
            <ep-table-item column="menuUrl" title="menuUrl" width="200"></ep-table-item>
            <ep-table-item column="menuAlter" title="menuAlter" width="180"></ep-table-item>
            <ep-table-item column="menuOrder" title="menuOrder" width="120"></ep-table-item>
            <ep-table-item column="notes" title="notes"></ep-table-item>
          </ep-table>
        </div>
        <div class="block">

  ...
  <div class="panel-main-content">
    ...
    <div class="search-card contents-card card-margin">
      <div class="panel panel-default">
        ...
        <ep-tabs active="设备数据表头">
          <ep-tab-item name="设备数据表头">
          ...
          <ep-tab-item name="设备数据表体">
            <div>
              <!-- 表体model -->
              <ep-model title="设备数据表体" v-model="bwsDtFormIsshow" :wrap-close="false" width="1200px"  >
                  ...
                  <ep-row :gutter="7">
                    ...
                    <ep-col :col="8">
                      <ep-form-item attr="inQty" label="入仓数量">
                        <ep-input disabled v-model="bwsDtForm.inQty" name="inQty" :maxlength="20"></ep-input>
                      </ep-form-item>
                    </ep-col>
                    <ep-col :col="8">
                      <ep-form-item attr="inLawfQty" label="入仓法定数量">
                        <ep-input disabled v-model="bwsDtForm.inLawfQty" name="inLawfQty" :maxlength="20"></ep-input>
                      </ep-form-item>
                    </ep-col>
                    <!-- <ep-col :col="8">
              ...
              <div class="search-card contents-card card-margin">
                <div class="panel panel-default">
                  ...
                  <ep-form ref="customSearch" :form="customSearch" name-width="150px">
                    <ep-row :gutter="7" >
                      <ep-col :col="6">
                        <ep-form-item label="商品备案序号" attr="putrecSeqno">
                          <ep-input v-model="customSearch.gdsSeqno" name="putrecSeqno" ></ep-input>
                        </ep-form-item>
                      </ep-col>
                      <ep-col :col="6">
              ...
              <div class="ep-card card-margin relative">
                <div class="card-body">
                  ...
                  <div class="block">
                    <ep-table ref="table" :head-color="headColor" :height="400" :data="tableData" @selection-change="handleSelect" @row-dblclick="selectInfo">
                      <!-- <ep-table-item type="select"></ep-table-item> -->

                      <ep-table-item column="gdsSeqno" title="商品备案序号" width="180"></ep-table-item>
                      ...
                      <ep-table-item column="inLawfQty" title="入仓法定数量" width="150"></ep-table-item>
                  ...
                  <ep-row :gutter="7">
                    ...
                    <ep-col :col="24">
                      <ep-form-item attr="remark" label="备注" >
                        <ep-input :readonly="true" :rows="4" type="textarea" v-model="bwsStatusDtForm.remark" name="remark"></ep-input>
                      </ep-form-item>
                    </ep-col>
...
export default {
  name: "equipmentBookDtInfo", // 保持和文件名一致，否则keep-alive不会动态缓存
  ...
  mounted() {
    ...
    this.$post("getLogisticsById", data)
      .then(responseData => {
        ...
        // this.tableData = tableDataParams;
         this.tableDataCopy = cloneObj(tableDataParams)

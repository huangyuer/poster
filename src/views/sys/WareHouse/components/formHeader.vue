  ...
  <div>
    <ep-form ref="bodyForm"
      ...
      <ep-row :gutter="7">
        ...
        <ep-col :col="8" v-if="showrltWhRecNo">
        ...
        <ep-col :col="8">
          <ep-form-item label="关联编号" attr="rltWhRecNo" v-if="fly">
            <ep-select v-model="bodyForm.rltWhRecNo" name="rltWhRecNo"  @change="rlts"  filterable>
              <ep-select-item v-for="item in UsedTypecd" :key="item.key" :index="item.buNo" :label="item.buNo" :disabled="!displayBlock || changeDis"></ep-select-item>
            </ep-select>
          </ep-form-item>
        </ep-col>
        <ep-col :col="8">
        ...
        <ep-col :col="8">
          <ep-form-item attr="ieTypecd"
            ...
            <ep-select v-model="bodyForm.ieTypecd"
                       name="ieTypecd"
                       :disabled="!displayBlock||ieTypecdStatus || changeDis || fly"
        ...
        <ep-col :col="8">
          <ep-form-item attr="mtpckEndprdTypecd"
            ...
            <ep-select v-model="bodyForm.mtpckEndprdTypecd"
                       ...
                       :disabled="!displayBlock || changeDis" @change="mtpckEndprd">
              <ep-select-item index="I"
              ...
              <ep-select-item index="S"
                              label="设备"></ep-select-item>
                               <ep-select-item index="L"
                              label="边角料"></ep-select-item>
                              <ep-select-item index="D"
                              label="残次品"></ep-select-item>
            </ep-select>
          </ep-form-item>
        </ep-col>
        <ep-col :col="8">
...
export default {
  ...
  methods: {
    changeTrade(){
      let type=this.bodyForm.inExpType
    ...
    inExpChange (value) {
      ...
      if (this.stateValue == 4 && this.ieTypecdState == "E") {
       ...
       if(this.bodyForm.inExpType==7||this.bodyForm.inExpType==8){
        this.bodyForm.ieTypecd='E'
        this.fly=true
        this.changeTrade()
        this.showrltWhRecNo=false
      }else{
        this.fly=false
        this.showrltWhRecNo=true
      }
    },
    rlts(){
      this.rltWhRecNoState=this.bodyForm.rltWhRecNo
      this.$emit("rltWhRecNochange", this.rltWhRecNoState);

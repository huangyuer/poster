  ...
  <div>
    <div>
            ...
            <ep-col :col="8">
              <ep-form-item attr="goodsType" label="货物类型">
                <ep-select v-model="bodyForm.goodsType" name="goodsType" :disabled="isDisabled || displayBlock || editBody">
                  ...
                  <!-- <ep-select-item index="3" label="内销" :disabled="showBusiness"></ep-select-item> -->
                </ep-select>
              </ep-form-item>
            </ep-col>
            <ep-col :col="8">
      ...
      <div class="ep-card card-margin relative">
        <div class="card-body">
          <div class="block" v-if="bodyInChange">
          ...
          <div class="block">
            <ep-table border ref="table" :height="400" :data="tableData" :head-color="headColor" @row-dblclick="queryOperStatus">
              ...
              <ep-table-item column="opt" title="操作" width="200" v-if="bodyInChange">
    ...
    <ep-model title="变更表体" v-model="isShowSasDtModel" width="1600px">
      <bodyFormModel :bodyForm="bodyForm" :isShowModel="isShowSasDtModel" @onSelectDt="handleSelectDt" :tableData="tableData" :consumptionNo="consumptionNo" :type="'1'"></bodyFormModel>
    </ep-model>
  </div>
</template>
  ...
  methods: {
    ...
    doBodyAdd() {
      ...
      if (this.changeType) {
        this.disAbled = true;
        this.disa = false;
        console.log(this.disAbled, "biangeng------------");
      }
      this.$refs.bodyForm && this.$refs.bodyForm.reset();
    },
        ...
        this.$refs["bodyForm"].validate((valid) => {
          if (valid) {
            if (this.buttonStatus == 0) {
              ...
              this.$refs.bodyForm && this.$refs.bodyForm.reset();
              (this.bodyForm.consumptionNo = this.headerForm.consumptionNo),

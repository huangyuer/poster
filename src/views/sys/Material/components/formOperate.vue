<template>
  <div>
    <div v-if="isOperate">
      <ep-model title="操作记录" :wrap-close="false" v-model="model" width="1250px">
        <ep-form ref="table" :form="operateForm" name-width="168px">
          <ep-row :gutter="7">
            <ep-col :col="8">
              <ep-form-item attr="createTime" label="创建时间">
                <ep-input disabled v-model="operateForm.createTime" name="createTime"></ep-input>
              </ep-form-item>
            </ep-col>
            <ep-col :col="8">
              <ep-form-item attr="optStatus" label="操作状态">
                <ep-select disabled v-model="operateForm.optStatus" name="optStatus">
            ...
            <ep-col :col="8">
              <ep-form-item attr="optUserName" label="操作人">
                <ep-input disabled v-model="operateForm.optUserName" name="optUserName"></ep-input>
              </ep-form-item>
            </ep-col>
            <ep-col :col="8">
              <ep-form-item attr="optTime" label="操作时间">
                <ep-input disabled v-model="operateForm.optTime" name="optTime"></ep-input>
              </ep-form-item>
            </ep-col>
            <ep-col :col="24">
              <ep-form-item attr="remark" label="备注">
                <ep-input :rows="4" :readonly="true" type="textarea" v-model="operateForm.remark" name="remark"></ep-input>
              </ep-form-item>
            </ep-col>
          </ep-row>
        </ep-form>
      ...
      <div class="ep-card card-margin relative">
        <div class="card-body">
          <div class="block">
            <ep-table border ref="table" :height="400" :data="operateData" :loading="loading" head-color @row-dblclick="queryOperStatus2">
    ...
    <div v-else>
          ...
          <ep-row :gutter="7">
            <ep-col :col="8">
              <ep-form-item attr="portNo" label="卡口凭证编号">
                <ep-input disabled v-model="portForm.portNo" name="portNo"></ep-input>
              </ep-form-item>
            </ep-col>

            <ep-col :col="8">
              <ep-form-item attr="rtlTypecd" label="单证类型">
                <ep-input disabled v-model="portForm.rtlTypecd" name="rtlTypecd"></ep-input>
              </ep-form-item>
            </ep-col>
          </ep-row>
        </ep-form>
      ...
      <div class="ep-card card-margin relative">
        <div class="card-body">
          <div class="block">
            <ep-table border ref="table" :height="400" :data="portData" :loading="loading" head-color @row-dblclick="queryOperStatus1">
              <ep-table-item column="portNo" width="200" title="卡口凭证编号"></ep-table-item>

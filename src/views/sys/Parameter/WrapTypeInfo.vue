    ...
    <div class="search-card contents-card card-margin">
      <div class="panel panel-default">
        <ep-form ref="searchForm" :form="searchForm" name-width="120px">
          <ep-row :gutter="7">
            <ep-col :col="8">
              <ep-form-item attr="wrapCode" label="包装种类">
                <ep-input placeholder="包装种类" v-model="searchForm.wrapCode" name="wrapCode" :maxlength="50"></ep-input>
              </ep-form-item>
            </ep-col>
            <ep-col :col="8">
              <ep-form-item attr="wrapName" label="包装名称">
                <ep-input placeholder="包装名称" v-model="searchForm.wrapName" name="wrapName" :maxlength="100"></ep-input>
              </ep-form-item>
            </ep-col>
            <ep-col :col="4">
      ...
      <div class="card-body">
        ...
        <div class="block">
          <ep-table ref="table" :height="400" :data="ep_data" @selection-change="handleSelectionChange" can-edit :loading="loading">
            ...
            <ep-table-item column="wrapCode" title="包装种类" width="200"></ep-table-item>
            <ep-table-item column="wrapName" title="包装名称" width="180"></ep-table-item>

    ...
    <div class="search-card contents-card card-margin">
      <div class="panel panel-default">
        <ep-form ref="searchForm" :form="searchForm" name-width="120px">
          <ep-row :gutter="7">
            <ep-col :col="8">
              <ep-form-item attr="currCode" label="币制代码">
                <ep-input placeholder="币制代码" v-model="searchForm.currCode" name="currCode" :maxlength="50"></ep-input>
              </ep-form-item>
            </ep-col>
            <ep-col :col="8">
              <ep-form-item attr="currSymb" label="英文名称">
                <ep-input placeholder="英文名称" v-model="searchForm.currSymb" name="currSymb" :maxlength="100"></ep-input>
              </ep-form-item>
            </ep-col>
            <ep-col :col="8">
              <ep-form-item attr="currName" label="名称">
                <ep-input placeholder="名称" v-model="searchForm.currName" name="currName" :maxlength="100"></ep-input>
              </ep-form-item>
            </ep-col>
          </ep-row>
          <ep-row :gutter="7">
      ...
      <div class="card-body">
        ...
        <div class="block">
          <ep-table ref="table" :height="400" :data="ep_data" @selection-change="handleSelectionChange" can-edit :loading="loading">
            ...
            <ep-table-item column="currCode" title="币制代码" width="200"></ep-table-item>
            <ep-table-item column="currSymb" title="英文名称" width="180"></ep-table-item>
            <ep-table-item column="currName" title="名称" width="180"></ep-table-item>
          </ep-table>
        </div>
        <div class="block">

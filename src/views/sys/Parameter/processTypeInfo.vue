    ...
    <div class="search-card contents-card card-margin">
      <div class="panel panel-default">
        <ep-form ref="searchForm" :form="searchForm" name-width="120px">
          <ep-row :gutter="7">
            <ep-col :col="8">
              <ep-form-item attr="proCode" label="加工种类代码">
                <ep-input placeholder="加工种类代码" v-model="searchForm.proCode" name="proCode" :maxlength="50"></ep-input>
              </ep-form-item>
            </ep-col>
            <ep-col :col="8">
              <ep-form-item attr="proName" label="加工种类名称">
                <ep-input placeholder="加工种类名称" v-model="searchForm.proName" name="proName" :maxlength="100"></ep-input>
              </ep-form-item>
            </ep-col>
            <ep-col :col="4">
      ...
      <div class="card-body">
        ...
        <div class="block">
          <ep-table ref="table" :height="400" :data="ep_data" @selection-change="handleSelectionChange" can-edit :loading="loading">
            ...
            <ep-table-item column="proCode" title="加工种类代码" width="200"></ep-table-item>
            <ep-table-item column="proName" title="加工种类名称" width="180"></ep-table-item>

    ...
    <div class="search-card contents-card card-margin">
      <div class="panel panel-default">
        <ep-form ref="searchForm" :form="searchForm" name-width="120px">
          <ep-row :gutter="7">
            <ep-col :col="8">
              <ep-form-item attr="trafCode" label="运输方式代码">
                <ep-input placeholder="运输方式代码" v-model="searchForm.trafCode" name="trafCode" :maxlength="50"></ep-input>
              </ep-form-item>
            </ep-col>
            <ep-col :col="8">
              <ep-form-item attr="trafSpec" label="运输方式名称">
                <ep-input placeholder="运输方式名称" v-model="searchForm.trafSpec" name="trafSpec" :maxlength="100"></ep-input>
              </ep-form-item>
            </ep-col>
            <ep-col :col="4">
      ...
      <div class="card-body">
        ...
        <div class="block">
          <ep-table ref="table" :height="400" :data="ep_data" @selection-change="handleSelectionChange" can-edit :loading="loading">
            ...
            <ep-table-item column="trafCode" title="运输方式代码" width="200"></ep-table-item>
            <ep-table-item column="trafSpec" title="运输方式名称" width="180"></ep-table-item>

      ...
      <div class="card-body">
        ...
        <div class="block">
          <ep-table ref="table" :height="400" :data="ep_data"  
            ...
            <ep-table-item column="usdRate" title="美元汇率" width="200"></ep-table-item>
            <ep-table-item column="rmbRate" title="人民币汇率" width="180"></ep-table-item>
          </ep-table>
        </div>
        <div class="block">

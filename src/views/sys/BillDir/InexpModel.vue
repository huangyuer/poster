  ...
  <div class="search-table card">
    ...
    <div class="block">
      <ep-table ref="table" border :height="400" highlight-row :data="ep_data" :head-color="headColor">
        ...
        <ep-table-item column="inOutBondedTypeName" title="出入库类型" width="120"></ep-table-item>
        ...
        <ep-table-item column="tradeMode" title="监管方式" width="180" :formatter="supvModecdFormatter"></ep-table-item>
        ...
        <ep-table-item column="declTypeName" title="报关标志" width="160"></ep-table-item>
        ...
        <ep-table-item column="copGNo" title="商品料号" width="140"></ep-table-item>
        <ep-table-item column="codeTs" title="商品编码" width="140"></ep-table-item>
        ...
        <ep-table-item column="qty1" width="160" title="法定数量"></ep-table-item>
        <ep-table-item column="unit1" width="140" title="法定单位" :formatter="dclUnitcdTranslate1"></ep-table-item>
        <ep-table-item column="qty2" width="160" title="法定第二数量"></ep-table-item>
        <ep-table-item column="unit2" width="200" title="法定第二计量单位" :formatter="dclUnitcdTranslate2"></ep-table-item>
        <ep-table-item column="tradeCurr" width="140" title="币制" :formatter="tradeCurrFormatter"></ep-table-item>

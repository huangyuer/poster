    ...
    <div class="search-card contents-card card-margin">
      <div class="panel panel-default">
        <div class="block">
          ...
          >确认</ep-button>-->
          <WmsButton type="save" :loading="saveLoading" @click="doSave">暂存</WmsButton>
          <WmsButton type="confirm" :loading="applyLoading" @click="declare">确认</WmsButton>
        </div>
              ...
              <ep-row :gutter="10">
                ...
                <!-- <ep-col :col="8">
                  <ep-form-item label="径予放行自主声明编号" attr="billNo">
                    <ep-input v-model="bodyForm.billNo" name="billNo" :maxlength="18" :disabled="true"></ep-input>
                  </ep-form-item>
                </ep-col>-->
                ...
                <ep-col :col="8">
                  <ep-form-item label="申报单位名称" attr="bizopEtpsNmAttr">
                    <ep-input
                      v-model="bodyForm.bizopEtpsNmAttr"
                      name="grossWt"
                      :maxlength="20"
                      :disabled="true"
                    ></ep-input>
                ...
                <ep-col :col="8">
                  <ep-form-item label="申报企业编号" attr="bizopEtpsNoAttr">
                    <ep-input
                      v-model="bodyForm.bizopEtpsNoAttr"
                      name="grossWt"
                      :maxlength="20"
                      :disabled="true"
                    ></ep-input>
                ...
                <ep-col :col="8">
                  <ep-form-item label="申报单位社会信用代码" attr="bizopEtpsSccdAttr">
                    <ep-input
                      v-model="bodyForm.bizopEtpsSccdAttr"
                      name="grossWt"
                      :maxlength="20"
                      :disabled="true"
                    ></ep-input>
                  ...
                  <div class="one-item-select">
                    <ep-form-item>
                      ...
                      <div>
                        ...
                        >不属于法律、法规等明确规定的,涉及我国缔结或者参加的国际条约、协定的,和涉及安全准入管理,必须在进出境环节验核相关监管证件的货物。</ep-checkbox>
                      </div>
                    </ep-form-item>
                  </div>
                </ep-col>
    ...
    doSave() {
      this.$refs["bodyForm"].validate(valid => {
        if (valid) {
          ...
          //状态下可以暂存
          console.log(this.bodyForm.optStatus);
          if (

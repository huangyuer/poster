				...
				<div class="card-body">
					...
					<div class="block">
						<ep-table ref="table" :height="400" :data="ep_data" :head-color="headColor" :loading="loading" >
                            ...
                            <ep-table-item column="goodQty" title="总库存" width="200"></ep-table-item>
                            <ep-table-item column="dayQty" title="今日库存" width="200"></ep-table-item>
                            <ep-table-item column="beforeQty" title="前日总库存" width="200"></ep-table-item>
...
export default {
  name: "earlyStockInfo", // 保持和文件名一致，否则keep-alive不会动态缓存
  ...
  data() {
    return {
      ...
      optType:"1",
      loading: false,
      listApi: "woInventoryGetInventoryList", // 搜索，取api.json里面的key值

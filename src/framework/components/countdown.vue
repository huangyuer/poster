<template>
  <div>
    <p v-if="msTime.show">
      ...
      <span class="word-color-time">&nbsp;{{msTime.hour}}&nbsp;</span><span >{{hourTxt}}</span><span class="word-color-time">&nbsp;{{msTime.minutes}}&nbsp;</span><span >{{minutesTxt}}</span><span class="word-color-time">&nbsp;{{msTime.seconds}}&nbsp;</span><span >{{secondsTxt}}</span>
    </p>
...
//                    this.secondsFixed ? msTime.seconds = new Number(timeDistance / 1000).toFixed(2) : msTime.seconds = Math.floor( timeDistance / 1000 ).toFixed(0);
          ...
          // console.log(msTime.hour+msTime.minutes+msTime.seconds)
          if(msTime.hour+msTime.minutes+msTime.seconds=="003000"||msTime.hour+msTime.minutes+msTime.seconds=="000500"){
            this.$emit('propsTimes',true,msTime.minutes);
          }
